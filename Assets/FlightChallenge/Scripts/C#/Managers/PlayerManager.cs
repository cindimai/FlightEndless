...
public class PlayerManager : MonoBehaviour
{
	...
	//A link to the Level Manager
	public Transform prefab;
	public float speedOfBulletX;
	public float speedOfBulletY;
	public float speedOfBulletZ;
	public bool flag = true;
	public Sprite[] subTextures;
	//The array containing the sub and sub damaged textures
	public SpriteRenderer subRenderer;
	//A link to the sub material

	public Transform extraSpeedFront;
	//The extra speed front sprite
	public Transform extraSpeedTail;
	//The extra speed trail sprite
	...
	//The maximum rotation of the submarine

	public float maxVerticalSpeed;
	//The maximum vertical speed
	public float depthEdge;
	//The edge fo the smoothing zone (minDepth- depthEdge and maxDepth - depthEdge)

	public ParticleSystem smoke;
	//The smoke particle
	public ParticleSystem bubbles;
	//The submarine bubble particle system
	public ParticleSystem reviveParticle;
	//The revive particle

	public PolygonCollider2D normalCollider;
	//The normal collider of the submarine
	public CircleCollider2D shieldCollider;
	//The collider of the shield
	...
	private float speed;
	//The actual vertical speed of the submarine
	private float newSpeed;
	//The new speed of the submarine, used at the edges

	private float rotationDiv;
	//A variable used to calculate rotation
	private Vector3 newRotation;
	//Stores the new rotation angles

	private float distanceToMax;
	//The current distance to the maximum depth
	private float distanceToMin;
	//The current distance to the minimum depth

	private Vector2 startingPos;
	//Holds the starting position of the submarine
	...
	void Update ()
	{
		...
		if (flag) {
			if (Input.GetKeyDown ("space")) {
				...
				bullet.GetComponent<Rigidbody2D> ().velocity = (new Vector3 (speedOfBulletX, speedOfBulletY, speedOfBulletZ) * Time.deltaTime);
//			rb.velocity = (new Vector3 (speedOfBulletX, speedOfBulletY, speedOfBulletZ) * Time.deltaTime);
			}
		}
	}
