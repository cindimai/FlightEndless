...
public class GUIManager : MonoBehaviour
{
	...
	//A link to the mission manager
	public PlayerManager playerManager;
	//A link to the player manager
	public PowerupManager powerupManager;
	//A link to the powerup manager
	public PlayerManager pm;

	public TextMesh hangarDistanceText;
	//A link to the hangar distance text

	public Text distanceText;
	//The main UI's distance text
	public Text coinText;
	//The main UI's coin ammount text

	public Text finishDistanceText;
	//The finish menu's distance text
	public Text finishCoinText;
	//The finish menu's coin ammount text

	public GameObject mainUI;
	//The main UI
	public GameObject pauseButton;
	//The Pause button on the main ui

	public Sprite[] arrowSprites;
	//Up and down arrow sprites
	public Sprite[] audioSprites;
	//Audio enabled and disabled sprites
	public Sprite[] ShopSkinButtonSprites;
	//The buy, equip, equipped sprites

	public Animator overlayAnimator;
	//The overlay animator
	public Animator topMenuAnimator;
	//The top menu animator
	public Animator shopAnimator;
	//The shop menu animator
	public Animator missionMenuAnimator;
	//The mission menu animator
	public Animator pauseMenuAnimator;
	//The pause menu animator
	public Animator finishMenuAnimator;
	//The finish menu animator
	public Animator[] powerupButtons;
	//The powerup buttons animator (extra speed, shield, sonic wave, revive)
	public Animator[] missionNotifications;
	//THe mission complete notification panels

	public RectTransform[] missionPanelElements;
	//The mission panel elements (mission descriptions and mission status)

	public Text coinAmmount;
	//The shop menu coin ammount text
	public Text[] ShopOwnedItems;
	//The shop menu number of owned item texts

	public Image[] shopSubmarineButtons;
	//The shop menu submarine 1 and 2 buttons
